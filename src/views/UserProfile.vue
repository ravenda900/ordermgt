                        ...
                        <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="text-center">
                                ...
                                <div class="h5 font-weight-300">
                                    <i class="ni location_pin mr-2"></i>Cebu, Philippines
                                </div>
                                <div class="h5 mt-4">
                            ...
                            <form @submit.prevent>
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group">
                                        <base-input alternative=""
                                                    label="About Me">
                                            <textarea rows="4" class="form-control form-control-alternative" placeholder="A few words about you ...">Describe yourself...</textarea>
                                        </base-input>
                                    </div>
                                </div>
                            </form>
